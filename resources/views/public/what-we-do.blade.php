...
@section('content')
    ...
    <section class="relative min-h-[50vh] flex items-center overflow-hidden bg-navy">
        ...
        <div class="absolute inset-0" style="background-image: radial-gradient(circle at 70% 30%, rgba(192, 57, 43, 0.08) 0%, transparent 50%), radial-gradient(circle at 30% 70%, rgba(192, 57, 43, 0.06) 0%, transparent 50%);"></div>
